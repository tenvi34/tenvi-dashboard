...
export const translations = {
  ko: {
    ...
    settings: {
      ...
      backupNote:
        'Tasks, Notes, Board 게시글, Calendar 일정, 언어, 시작 모듈, 테마 설정, Map 사진 기록을 백업합니다. Board 이미지, 카테고리, 임시저장은 Board 전용 백업을 사용하세요.',
      mapBackupNote:
  ...
  en: {
    ...
    settings: {
      ...
      backupNote:
        'Backs up Tasks, Notes, Board posts, Calendar events, language, start module, theme settings, and Map photo records. Use the Board dedicated backup for Board images, categories, and drafts.',
      mapBackupNote:
